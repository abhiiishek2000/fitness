...
class SpaScreen extends StatefulWidget {
  const SpaScreen({Key? key,required this.cityname,required this.cityid}) : super(key: key);
  final String cityid;
    ...
    setState(() {
      ...
      spadata.forEach((element) {
        ...
        Map tmpArray={
          ...
          "spaeatleft":(element['seat_left'].toString()),
            ...
            children:[
              Container(
                ...
                child: TextField(
                  ...
                  onChanged: (query) {
                    final searchResult = spa.where((element) {
              ...
              InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => newcitysearch(isFromGYM: false,isFromSapa: true,isFromYoga: false),
                    ),
                  );
                },
                child: Row(children: [

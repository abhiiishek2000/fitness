...
class GymPage extends StatefulWidget {
  const GymPage({Key? key,required this.cityname,required this.cityid}) : super(key: key);
  final String cityid;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body:  (_gymprogressBarActive == true ?
        Container(
              ...
              Container(
                ...
                child: TextField(
                  decoration: InputDecoration(
                    ...
                    onChanged: (query) {
               final searchResult = gyms.where((element) {

...
class OnePassLiveScreen extends StatefulWidget {
  const OnePassLiveScreen({Key? key}) : super(key: key);

  @override
  _OnePassLiveScreenState createState() => _OnePassLiveScreenState();
}

class _OnePassLiveScreenState extends State<OnePassLiveScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("OnePass LIVE",style: GoogleFonts.roboto(),),
        elevation: 0,
      ),
      bottomSheet: InkWell(
        ...
        child: Container(
          ...
          child: Center(child: Text("GET ONEPASS AT LOWEST PASS",style: GoogleFonts.roboto(fontWeight: FontWeight.w600,color: Colors.white),)),
           ),
      ),
      body: ListView(
        children: [

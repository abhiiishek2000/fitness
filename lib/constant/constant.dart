...
import 'package:go_fit_now/model/aeospecials.dart';
import 'package:go_fit_now/model/arealocationlist.dart';
import 'package:go_fit_now/model/exploreaeohotelslist.dart';
import 'package:go_fit_now/model/latestaeo.dart';
import 'package:go_fit_now/model/limitedperiodofferlist.dart';
import 'package:go_fit_now/model/readyforsummerlist.dart';
import 'package:go_fit_now/model/weekendgetawayslist.dart';
import 'package:go_fit_now/model/yourwalletslist.dart';

class Constants{

  static final String HOME_SCREEN = 'OYO_UI';
